...
# df_n$ln_crime_count <- log(df_n$actual_all_crimes+1)
...
pca <- post_processing(data_type="na",crime_abbr="c",crime_name="crime",title="Event study of total crime (Alternative UCR)",freq="annual",alt=TRUE)
```
...
# the following function saves the figure and prints a latex table as well
pa_b <- post_processing(data_type="na",crime_abbr="b",crime_name="burglary",title="Event study of burglary (Alternative UCR)",freq="annual",alt=TRUE)
```
